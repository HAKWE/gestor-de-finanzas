...
function AddTransactionModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      {/* Sheet / Dialog */}
      <div
        className="bg-background w-full sm:max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl flex flex-col"
        style={{ height: "92vh" }}
      >
        {/* Header */}
        ...
        {/* Scrollable body */}
        <div className="px-5 py-5 space-y-5" style={{ flex: "1 1 0", overflowY: "auto", minHeight: 0 }}>
